...
const translations = {
  en: {
    ...
    home_style: 'Dress code: Colorful, comfortable for the summer and bring flat shoes for walking. Wear something that makes you feel happy: no need to dress formally!',
  ...
  fr: {
    ...
    home_style: 'Code vestimentaire : Coloré, confortable pour l\'été et apportez des chaussures plates pour marcher. Portez quelque chose qui vous rende heureux·se — pas besoin d\'être formel !',
