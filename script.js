...
const translations = {
  en: {
    ...
    home_style: 'Dress code: Colorful and comfortable for the summer. Wear something that makes you feel happy: no need to dress formally!',
    ...
    venue_history_2: 'More information about the castle and estate is available at the link below.',
    ...
    venue_notes_4: 'Bring comfortable clothes that are appropriate for hot weather and comfortable shoes',
    ...
    schedule_1: 'Ceremony',
    schedule_2: 'Photos, cocktails, snacks, games and relaxing, a "vin d\'honneur"',
    schedule_3: 'Dinner - mains, cheese and dessert',
    schedule_4: 'Music starts for an evening of dancing',
  ...
  fr: {
    ...
    home_style: 'Code vestimentaire : Coloré et confortable pour l\'été. Portez quelque chose qui vous rende heureux·se — pas besoin d\'être formel !',
    ...
    venue_history_1: 'Le château de Nitray a été construit au XVIᵉ siècle, probablement pour remplacer un ancien château datant du XIIIᵉ siècle. Le château de Nitray produit du vin depuis le XVIIIᵉ siècle. Il suit des méthodes de production traditionnelles et ne produit que des vins biologiques. Ces vins portent l\'appellation de la région locale, AOC Touraine.',
    venue_history_2: 'Plus d\'informations sur le château et le domaine sont disponibles au lien ci-dessous.',
    venue_website: 'Consulter le site officiel',
    venue_notes_title: 'Infos sur le lieu',
    venue_notes_1: 'Espaces exterieurs pour la ceremonie de mariage et les cocktails',
    venue_notes_2: 'Espaces interieurs pour le diner et la danse',
    venue_notes_3: 'Une petite foret pour une promenade l\'apres-midi',
    venue_notes_4: 'Apportez des vetements confortables adaptes a des temperatures chaudes et des chaussures confortables',
    venue_address_title: 'Adresse',
    venue_address_line: 'Chateau de Nitray, 31 Nitray, 37270 Athee-sur-Cher, France',
    venue_map: 'Voir sur Google Maps',
    tab_schedule: 'Programme',
    schedule_title: 'Programme',
    schedule_intro: 'Voici un programme approximatif des evenements de la journee. Les horaires sont approximatifs et peuvent varier legerement.',
    schedule_1: 'Ceremonie',
    schedule_2: 'Photos, cocktails, collations, jeux et moment de detente, un "vin d\'honneur"',
    schedule_3: 'Diner - plats, fromage et dessert',
    schedule_4: 'La musique commence pour une soiree de danse',
    schedule_5: 'Collations et rafraichissements',
    schedule_6: 'La fete se termine',
